...
describe('MeetingUtil', () => {
  ...
  describe('generateCSV', () => {
    it('should generate empty csv', () => {
      ...
      expect(MeetingUtil.generateCSV(attendees)).toBe(result);
    });
    ...
    it('should generate empty csv', () => {
      ...
      const users = [
        {username: 'a', firstname: 'af', lastname: 'al'},
        {username: 'b', firstname: 'bf', lastname: 'bl'}
      ];

      const result = 'Firstname,Lastname,has taken part\naf,al,true\nbf,bl,false';

      expect(MeetingUtil.generateCSV(attendees)).toEqual(result);
    });
