...
@Component({
  selector: 'evendemy-meeting-list-new',
  templateUrl: './meeting-list-new.component.html',
  styleUrls: ['./meeting-list-new.component.scss']
})
export class MeetingListNewComponent extends BaseComponent implements OnInit {
